...
export const GryffindorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => (
  <svg
...
export const RavenclawIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const HufflepuffIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const SlytherinIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const SortingHatIcon: React.FC<{
  className?: string;
  size?: number;
...
export const SortingHatImage: React.FC<{
  className?: string;
  width?: number;
  height?: number;
}> = ({
